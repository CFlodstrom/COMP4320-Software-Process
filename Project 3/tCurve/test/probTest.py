...
class ProbTest(TestCase):
    ...
    def test100_970ShouldRaiseExceptionOnNonIntegerN(self):
        ...
        #         
        #Happy path analysis
        #        test 010: regular n, regular t
        #        test 020: regular t, low bound n
        #        test 030: regular t , high bound n
        #        
        #Sad path analysis
        #there is no sad path analysis
   
#     def test_200_010_testConstant(self):
#         t = self.setT(1)
#         n = self.setN(1)
#         expectedResult = 1.0
...
#         self.assertAlmostEqual(expectedResult, result, 3)
    ...
    def test200_020_testTandN(self):
        t = 1.0
        n = 5.0
        expectedResult = .8392
        result = _integrate(t, n, _f)
    ...
    def test200_030_nominalTandlowN(self):
        t = 2.0
        n = 3.0
        expectedResult = 1.1707
        result = _integrate(t, n, _f)
        self.assertAlmostEqual(expectedResult, result, 3) 
        
    def test200_040_lowTandhighN(self):
        t = 1.0
        n = 30.0
        expectedResult = .8527
        result = _integrate(t, n, _f)
